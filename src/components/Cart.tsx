  ...
  return (
    <Link href={`/${locale}/checkout`}>
      <div className="group relative cursor-pointer">
        {selectedNumber > 0 ? (
          <span
            className={`absolute -top-[5px] -right-2 bg-[#755272] rounded-full text-[12px] ${
        ...
        >
          ...
          >
            <path
              className="stroke-primary dark:stroke-white fill-primary dark:fill-white group-hover:stroke-[#755272] group-hover:fill-[#755272] transition-all duration-300 ease-in-out"
              id="Path_29875"
